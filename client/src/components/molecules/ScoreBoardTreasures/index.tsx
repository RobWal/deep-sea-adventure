...
const ScoreBoardTreasures = ({playerId}: any) => {
    ...
    else if(playerId !== undefined && appState.currentRound !== 4){
        return (
    ...
    else if(playerId !== undefined && (appState.currentStep === 'end_of_round_adjustments' && appState.currentRound === 4) || (appState.currentStep === 'tally_scores' && appState.currentRound === 4)){
        return (
            <div className='score-board-treasures'>
